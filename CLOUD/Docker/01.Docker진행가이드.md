...
/workshop
  ...
  └─ /workshop/dstone-compose.yml              # 전체 Docker Compose 빌드파일
```


### 13-1. dstone 프레임웍 설치 및 삭제
```bash
# Docker Compose 실행
docker-compose -p dstone -f /workshop/dstone-compose.yml up -d
# 로그 확인
docker-compose -p dstone -f /workshop/dstone-compose.yml logs -f
# 중지 및 삭제
docker-compose -p dstone -f /workshop/dstone-compose.yml down -v
```

### 13-2. dstone 프레임웍 Docker Hub 등록
```bash
